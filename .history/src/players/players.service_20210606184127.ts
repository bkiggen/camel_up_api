...
import { GamesEntity } from 'src/games/game.entity';
...
export class PlayersService {
  constructor(
    ...
    private playersRepository: PlayersRepository, // @InjectRepository(GamesRepository)
  ...
  async createPlayer(createPlayerDto: CreatePlayerDto): Promise<Player> {
    ...
    const game = await GamesEntity(gameId);
